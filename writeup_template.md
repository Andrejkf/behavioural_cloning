...
In particular, fast Deep Learning design approach was used for parameters tunning and the model implementation using a Deep Learning library  [Keras](https://keras.io/).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzNjQwNTc5OV19
-->